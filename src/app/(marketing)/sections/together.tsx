...
//
// PLACEMENT. Directly after <FeatureCards />. That grid CLAIMS things — a list
// of capabilities in a bento — and presence is the one item on any such list
// that cannot be understood from its own sentence. A screenshot of a workspace
// with agent avatars in it says this and says it as a still life; moving
// pointers with names on them say it the way you actually experience it, which
// is that somebody else is in here with you. So it lands right after the grid,
// as the payoff to the one claim the grid could not make.
//
