...
export function TimeTracker({ taskId }: { taskId: Id<"tasks"> }) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col gap-2 rounded-2xl panel p-3 sm:flex-row sm:items-center">
        {myRunningOnThisTask ? (
          <RunningPanel
...
function EntryRow({ entry }: { entry: Doc<"timeEntries"> }) {
  ...
  return (
    <li
      className={cn(
        "flex flex-col gap-2 rounded-2xl panel p-2 sm:flex-row sm:items-center",
