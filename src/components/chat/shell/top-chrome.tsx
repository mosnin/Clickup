    ...
    <header data-chat-top-chrome="" className="flex shrink-0 items-center px-2 pb-2 pt-2">
      <div className="flex min-h-12 w-full items-center gap-2 rounded-full bg-card py-1.5 pl-4 pr-2 shadow-[var(--ui-shadow-md)]">
        ...
        <p className="chat-quiet min-w-0 flex-1 truncate text-xs">
          <span
            className="mr-2 inline-flex shrink-0 items-center rounded-full border border-border px-1.5 py-0.5 text-tiny font-medium uppercase tracking-wider text-muted-foreground"
